                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check flex-fill">
                                    <input class="form-check-input" type="radio" name="role" id="jobseeker" value="jobseeker" {{ old('role') == 'jobseeker' || !old('role') ? 'checked' : '' }}>
                                ...
                                <div class="form-check flex-fill">
                                    <input class="form-check-input" type="radio" name="role" id="recruiter" value="recruiter" {{ old('role') == 'recruiter' ? 'checked' : '' }}>
